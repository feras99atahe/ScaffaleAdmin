...
import 'review_project_model.dart';
export 'review_project_model.dart';

class ReviewProjectWidget extends StatefulWidget {
  const ReviewProjectWidget({
    Key? key,
    this.bookdetail,
  }) : super(key: key);
  ...
  @override
  _ReviewProjectWidgetState createState() => _ReviewProjectWidgetState();
}

class _ReviewProjectWidgetState extends State<ReviewProjectWidget> {
  late ReviewProjectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewProjectModel());
  }
