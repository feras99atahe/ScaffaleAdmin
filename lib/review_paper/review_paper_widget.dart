...
import 'review_paper_model.dart';
export 'review_paper_model.dart';

class ReviewPaperWidget extends StatefulWidget {
  const ReviewPaperWidget({
    Key? key,
    this.bookdetail,
  }) : super(key: key);
  ...
  @override
  _ReviewPaperWidgetState createState() => _ReviewPaperWidgetState();
}

class _ReviewPaperWidgetState extends State<ReviewPaperWidget> {
  late ReviewPaperModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReviewPaperModel());
  }
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              valueOrDefault<String>(
                                                stackDataRecord.publicationData
                                                    ?.toString(),
                                                'Date',
                                              ),
                                              style:
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            EdgeInsetsDirectional.fromSTEB(
                                                8, 0, 8, 0),
                                            child: Text(
                                              stackDataRecord.pages.toString(),
                                              textAlign: TextAlign.start,
                                              style:
                                              FlutterFlowTheme.of(context)
                                                  .bodyMedium
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            EdgeInsetsDirectional.fromSTEB(
                                                8, 0, 8, 0),
                                            child: Text(
                                              stackDataRecord.volume.toString(),
                                              textAlign: TextAlign.start,
                                              style:
                                              FlutterFlowTheme.of(context)
                                                  .bodyMedium
